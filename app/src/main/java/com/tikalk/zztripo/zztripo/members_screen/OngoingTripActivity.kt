...
import com.tikalk.zztripo.zztripo.map.MapViewFragment
...
class OngoingTripActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_going_trip)
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menuInflater.inflate(R.menu.menu_going_trip, menu)
        return true
    }
    ...
    class PlaceholderFragment : Fragment() {
        ...
        override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
            ...
            val rootView = inflater.inflate(R.layout.fragment_going_trip, container, false)
